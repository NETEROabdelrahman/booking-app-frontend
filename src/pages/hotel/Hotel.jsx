...
import { fetchOneHotel } from "../../reducers/fetchOneHotelReducer";
...
const Hotel = () => {
  ...
  const handleClick = () => {
    if (localStorage.getItem("user")) {
      ...
      alert('you are not logged in! , you will be directed to login page.')
      navigate("/login");
    }
  };
  return (
      ...
      <div className="hotelContainer">
        {open && (
          <div className="slider">
            <i className="fa-regular fa-circle-xmark close" onClick={() => setOpen(false)}></i>
